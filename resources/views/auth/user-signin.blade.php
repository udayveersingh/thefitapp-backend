            ...
            <div
                ...
                <div class="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 lg:min-h-[758px] py-20">
                    ...
                    <div class="mx-auto w-full max-w-[440px]">
                        ...
                        @if(session('success'))
                        <h1 style="color:red">{{session('success')}}</h1>
                     @endif
                        <form method="POST" action="{{ route('user-login') }}" class="space-y-5 dark:text-white">
                          @csrf
                            <div>
                                    ...
                                    <a href="javascript:" class="inline-flex h-8 w-8 items-center justify-center rounded-full p-0 transition hover:scale-110"
                                        ...
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                                            ...
                                            <path
                                                ...
                                                fill="white" />
                                            <path d="M11.85 5.025C12.3333 5.025 12.725 4.63325 12.725 4.15C12.725 3.66675 12.3333 3.275 11.85 3.275C11.3668 3.275 10.975 3.66675 10.975 4.15C10.975 4.63325 11.3668 5.025 11.85 5.025Z"
                                                fill="white" />
                                        </svg>
                                    </a>
                                </li>
                        ...
                        {{-- <div class="text-center dark:text-white"> Don't have an account ? <a href="/auth/boxed-signup" class="uppercase text-primary underline transition hover:text-black dark:hover:text-white">SIGN UP</a>
                        </div> --}}
                    </div>
                </div>
            </div>
