    ...
    <nav x-data="sidebar"
        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'user_module' }"
                        @click="activeDropdown === 'user_module' ? activeDropdown = null : activeDropdown = 'user_module'">
                        <div class="flex items-center">
                        ...
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'user_module' }">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'user_module'" x-collapse class="sub-menu text-gray-500">
                        <li>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'Task_module' }"
                        @click="activeDropdown === 'Task_module' ? activeDropdown = null : activeDropdown = 'Task_module'">
                        <div class="flex items-center">
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'settings'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="{{route('settings.index')}}">Settings List</a>
                        </li>
                    </ul>
                </li>
