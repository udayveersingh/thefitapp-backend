    ...
    <nav x-data="sidebar"
        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="nav-item">
                    <a href="{{route('tasks.index')}}" class="group">
                        <div class="flex items-center">
                ...
                <li class="nav-item">
                    <a href="{{route('kyc-requests')}}" class="group">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">KYC Requests</span>
                        </div>
                    </a>
                </li>
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'kyc' }"
                        @click="activeDropdown === 'kyc' ? activeDropdown = null : activeDropdown = 'kyc'">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">KYC</span>
                        </div>
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'kyc' }">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'kyc'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="{{route('kyc-requests')}}">Pendings / New</a>
                        </li>
                        <li>
                            <a href="{{'kyc-approved'}}">Approved / Rejected</a>
                        </li>
                ...
                <li class="nav-item">
                    <a href="{{route('settings.index')}}" class="group">
                        <div class="flex items-center">
                            <svg class="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.42229 20.6181C10.1779 21.5395 11.0557 22.0001 12 22.0001V12.0001L2.63802 7.07275C2.62423 7.09491 2.6107 7.11727 2.5974 7.13986C2 8.15436 2 9.41678 2 11.9416V12.0586C2 14.5834 2 15.8459 2.5974 16.8604C3.19479 17.8749 4.27063 18.4395 6.42229 19.5686L8.42229 20.6181Z"
                                    fill="currentColor" />
                                <path opacity="0.7" d="M17.5774 4.43152L15.5774 3.38197C13.8218 2.46066 12.944 2 11.9997 2C11.0554 2 10.1776 2.46066 8.42197 3.38197L6.42197 4.43152C4.31821 5.53552 3.24291 6.09982 2.6377 7.07264L11.9997 12L21.3617 7.07264C20.7564 6.09982 19.6811 5.53552 17.5774 4.43152Z"
                                    fill="currentColor" />
                                <path opacity="0.5" d="M21.4026 7.13986C21.3893 7.11727 21.3758 7.09491 21.362 7.07275L12 12.0001V22.0001C12.9443 22.0001 13.8221 21.5395 15.5777 20.6181L17.5777 19.5686C19.7294 18.4395 20.8052 17.8749 21.4026 16.8604C22 15.8459 22 14.5834 22 12.0586V11.9416C22 9.41678 22 8.15436 21.4026 7.13986Z"
                                    fill="currentColor" />
                            </svg>
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'reports'" x-collapse class="sub-menu text-gray-500">
                        ...
                        <li>
                            <a href="{{'withdrawl-list'}}">Withdrawl</a>
                        </li>
                    </ul>
                </li>
